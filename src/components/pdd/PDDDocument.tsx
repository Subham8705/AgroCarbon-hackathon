    ...
    return (
        <div className="border rounded-lg p-8 bg-white text-sm space-y-8 font-serif text-slate-800 shadow-sm min-h-[600px] animate-fade-in">
            ...
            <div className="space-y-4">
                ...
                <ul className="list-disc pl-5 space-y-1">
                    <li><strong>Project Company (AgroCarbon):</strong> Responsible for farmer enrollment, data collection, and project implementation.</li>
            ...
            < div className="space-y-4" >
                ...
                <p className="leading-relaxed">
                    Monitoring will be conducted via remote sensing (NDVI, Sentinel-2) combined with annual soil sampling. Data is collected via the AgroCarbon mobile application and stored in a secure database with an audit trail for verification. Verification audits will be conducted by accredited third-party verifiers.
                </p>
            </div >
            ...
            <div className="pt-12 text-center text-slate-400 text-xs">
                Generated by AgroCarbon Platform • {new Date().toLocaleDateString()}
            </div>
        </div >
    );
}
